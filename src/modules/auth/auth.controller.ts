...
export const REFRESH_TOKEN_EXPIRES_DAYS_IN_SECONDS = REFRESH_TOKEN_EXPIRES_DAYS * 86400000; // 24 * 60 * 60
...
export class AuthController {
  ...
  @UseGuards(RefreshTokenGuard)
  @Get('sign-out')
  async signOut(@Req() req: IGetUserInfoRequest, @Response() res: Res) {
